...
import 'package:hungry_app/core/network/secure_storage_service.dart';
...
import '../bootstrap/hive_boxes.dart';
import '../network/dio_service.dart';
import '../network/profile_image_upload_service.dart';
...
Future<void> setupLocator() async {
  ...
  getIt.registerLazySingleton<AppImagePicker>(
    () => AppImagePicker(),
  );
  ...
  getIt.registerLazySingleton<ProfileImageUploadService>(
  ...
  getIt.registerLazySingleton<Box<ProductModel>>(
    () => Hive.box<ProductModel>(HiveBoxes.productBox),
  );

  getIt.registerLazySingleton<Box<CartItemModel>>(
    () => Hive.box<CartItemModel>(HiveBoxes.cartBox),
  );
  getIt.registerLazySingleton<Box<FavouriteModel>>(
    () => Hive.box<FavouriteModel>(HiveBoxes.favoriteBox),
  );

  getIt.registerLazySingleton<Box<OrderModel>>(
    () => Hive.box<OrderModel>(HiveBoxes.ordersBox),
  );
  //=========================//
  // Data Sources
  //=========================//
  ...
  getIt.registerLazySingleton<AuthRemoteDataSource>(
    () => AuthRemoteDataSourceImpl(
      ...
      cloudinaryService: getIt<ProfileImageUploadService>(),
    ),
  );
  ...
  getIt.registerLazySingleton<AuthCubit>(
    () => AuthCubit(
      ...
      imagePickerService: getIt<AppImagePicker>(),
    ),
  );
